...
const (
	INVOICESTATUS_InvoiceStatusFailed InvoiceStatus = "FAILED"
	INVOICESTATUS_InvoiceStatusPending InvoiceStatus = "PENDING"
	INVOICESTATUS_InvoiceStatusExpired InvoiceStatus = "EXPIRED"
	INVOICESTATUS_InvoiceStatusPaid InvoiceStatus = "PAID"
	INVOICESTATUS_InvoiceStatusCompleted InvoiceStatus = "COMPLETED"
)
